...
# 3. Final stage: Creates a minimal image with only what's needed to run the application
# Test will not be run with another Dockerfile.
# See README.md in tests/ for more information.
